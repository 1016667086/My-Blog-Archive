...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/96273a238a114131baf12e4153a7d193.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/dceb114945f0483a92df0e2d73cd6960.png)
...
官方地址：https://gitee.com/y\_project/RuoYi-Vue
...
通过idea克隆若依源码，仓库地址：https://gitee.com/y\_project/RuoYi-Vue.git

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/75955b5b87f44563b571bdd43147eabc.png)

##### Maven构建

使用idea打开项目后，等待环境检查（主要是Maven下载项目依赖）

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/f7d1774bc0aa485abe6cb5a93fe9302b.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/04995cb5ec9842a6b596f9bd03267363.png)

3、导入后`ry-vue`库内置30张表

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/2dca5a7dbd1d4d05abe432e89c1da2d9.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/cda7aacf217a41158acfcfe1784a2aaf.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/bfbba7e626a8427f97898379405b7708.png)

##### 配置信息

在`ruoyi-admin`模块下，`resources`目录下的`application.yml`，可以设置redis密码等相关信息

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/217eff79ca7f4ba599b67eed83af18d2.png)

#### 项目运行

在`ruoyi-admin`模块下，运行`com.ruoyi.RuoYiApplication.java`，出现如下图表示启动成功

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/0fd895bebc85438ca10b04cca6e7f498.png)

后端运行成功可以通过([http://localhost:8080 )访问，但是不会出现静态页面，可以继续参考下面步骤部署前端，然后通过前端地址来访问。

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/11961e20fcff42a9a40ab4591d913cfe.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/b824b6d870c94da3a6860f38d69bb31c.png)

打开浏览器，输入：([http://localhost:80) 默认账户/密码 `admin/admin123`）若能正确展示登录页面，并能成功登录，菜单及页面展示正常，则表明环境搭建成功

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/0943607cb5ae4d34a043a202167bf5f0.png)

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/24f47a622c1d4ec1a89943599fc77b60.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/a02d49873ff24e549275ce95e9bc7647.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/88a8e147e06d4e4f8c406f4f3d47c70c.png)

#### 系统导入

登录系统（系统工具 -> 代码生成 -> 导入课程表）

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/00ede06b041a452dafb5b33a3bec09e3.png)  
 ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/ca3e54e62a9749c1bd235adf8d6dd46d.png)

#### 配置代码

代码生成列表中找到课程表（可预览、编辑、同步、删除生成配置）

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/96ab8e20dafe46f6a9d53144ef366712.png)

#### 点击生成

点击生成代码，得到一个`ruoyi.zip`  
 ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/c752925c6e8045e8bcb8d1a3605a7dd3.png)

解压后得到：后端代码、前端代码、菜单sql

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/05270ce18e7648bc9abca073b5b326cb.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/9eedb14ae549446a93cf30587f09eee7.png)

> 注意：如果导入后的代码重启后没生效，可以通过maven先clean再启动，还是没显示的话把vue3的模板改成vue2的模板

#### 导入前端代码

将生成的前端代码，导入`ruoyi-ui`模块中

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/2ae096ee3a2544f6bbcaacda821db4c6.png)

### 访问测试

代码生成器默认生成的**课程管理**模块在**系统工具**菜单下，打开测试CRUD功能

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/f2f2c524f8c54c48bd70d0181c81b858.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/7303312eb95045fd98a577e0158de9db.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/0dba36e87e94415ea885ae18cd6ae766.png)

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/3e114d7f089341be8f86e41cda8572d7.png)

##### 案例

创建新用户小智并关联课研人员角色，仅限课程管理和统计分析菜单访问。

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/8fc32097c9d24bbcbcbfa534e82c117b.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/46ec8b7e8c3f4af6b0f74e033091225a.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/7352efb5984d40e6b389db29ff6865c4.png)

功能包括：字典类型管理、字典数据管理

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/79b25b85ff0b41bb9f2062503824ffd6.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/24cfd85eb81e44dcbd48c1a0d64cc4a1.png)

实现步骤：

①添加字典类型和数据

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/7e25205196214efdbbfdc7e05618bf4c.png)

②修改代码生成信息

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/4e68baa888a14e9aa5e1644261cc8d2a.png)

③下载代码，导入前端

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/36aeed44d95f4d06824b8804fb2f1391.png)

#### 参数设置

参数设置：对系统中的参数进行动态维护。

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/5b75b6c497784dfb8c0f5c44827ac1b4.png)

关闭登录验证码

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/d7589d88325040d3ac924c5ac9ba122c.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/0c347ec59b884953aace2956406c745e.png)
...
* 同样提供搜索和筛选功能，方便查找特定用户的登录历史。
  ...
  ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/29780a0931f6416a919624ce0ed476be.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/86cae3e0e847418db1a58cfcf0107033.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/199ecd885ab54722a7b55852cdcf027c.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/0748c4a9b16f44e099f97a58caf9186d.png)

实现步骤：

①创建任务类  
 ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/72e278c4f5d5491db760700b0a254c53.png)

②添加任务规则

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/59bbb6bc048b44608b85c6e477247343.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/8a42b03cc60c4f058b355645a7ee7df1.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/b76bf473f2614623b822d45a34620de0.png)

##### 案例

通过表单构建工具，单独制作一个添加课程的表单页面。  
 ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/f275cd6127bd45b9bc2555be9a8c85d1.png)

实现步骤：

①制作表单并导出

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/6aabfcadb3e34803969c1336220f7259.png)

②复制到前端工程  
 ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/5bf5efe2cd8544f986c55633b0ba5f43.png)

③创建动态菜单

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/798c81b10f264271a986e1585fb11072.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/1a980e9a010c4830a50c01acd119b79a.png)

代码生成配置主表实现细节：  
 ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/5a8874d6aa3145d7863069ce8f1c20c9.png)

#### 系统接口

* Swagger，能够自动生成 API 的同步在线文档，并提供Web界面进行接口调用和测试。

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/b93c9e8a536f4ef7829e5081581ec272.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/d1c84044bc2740b2ad324dfda0f76b82.png)

### 项目中配置

项目中的配置文件都在ruoyi-admin模块下，如下图：

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/e90b3f92bffc43c883c17b3c5d93cc18.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/f2b2bc355e43471fa8eb3cd46993970d.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/8ab1097bf75c43959d78a7d1f46e54ce.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/52f26aa242864efb944d2366109c956d.png)

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/b31b15dfc4be44a39bb3258afcd967f4.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/d06bb07afa3e4adba4d5c5bb20116c13.png)

#### TableDataInfo

分页查询统一返回对象：表格分页数据对象

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/5dd2b9ad3a88408fb5fbe90af78048b3.png)

#### AjaxResult

增删改查统一返回对象：操作消息提醒

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/3113189d75ab41ca94a5293a9eeb2c7d.png)

#### BaseEntity

所有实体类默认继承的BaseEntity基类

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/8a03c23ca9fa4fe3868438d65aa15772.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/728f80b852f545eb9f151f7d613ee12b.png)

权限控制流程图

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/50fbbd618d9c474ca92b29ca67882f67.png)

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/772deecdd6a24d52accc7dfac6040c68.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/bfa08050c65443359d44fcb916403aad.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/64ddb5cf843b40ca9be777e6c34878ef.png)

代理服务器是位于客户端和目标服务器之间的一台服务器，它接收客户端发送的请求，并将请求转发给目标服务器。通过在代理服务器上进行请求转发，可以绕过浏览器的同源策略限制，从而实现跨域请求。

在vue.config.js文件中添加以下内容：

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/31b644d4040a404aa869e59c8a4d7fe7.png)
...
地址：https://gitee.com/lpf\_project/RuoYi-MT/releases

资料中已提供，将项目打成压缩包，直接修改即可：

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/00b704569d4546b1afd18a4a4f2fe7ff.png)![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/02a060f1045d44429b4dcd0311b3446a.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/ed34024a20c84dc7aac44788e0f48d83.png)

##### 版本锁定

在`RuoYi-Vue`父工程`pom.xml`中进行版本锁定

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/500b6f0fc5884854802b13eb9c894977.png)

##### 添加模块依赖

在`ruoyi-admin`模块`pom.xml`中添加模块依赖

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/714eff4b3a2346259ea132d91907fbd6.png)

### 菜品管理

利用若依代码生成器（主子表模板），生成菜品管理的前后端代码。

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/bb260cf3af6447f0b4e4d5a186be953f.png)

#### 代码生成

①准备SQL并导入数据库

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/4a9ee414a69b4732bd09438c9d71eb02.png)

②配置代码生成信息

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/457eb1c198064d81965f410aecb489ff.png)

③下载代码并导入项目

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/b34d979ea180430f8b9fa1215cf44b9d.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/b51b8116c58c4e5db3bc504a407e5e9b.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/a2148fb9420c4c08bd7bd178167335d2.png)

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/b2d644e65bbf4d7d869cea5cee8924a0.png)

#### 浏览器标签页icon、标题

找到资料中的logo图标，替换前端项目中的public文件夹，删除原有的favicon.ico，把新拷贝过来的logo更名为favicon.ico即可

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/e7a32c784ad8466ca604d71828aff156.png)

找到根目录下的index.html文件，把title更换为自己想要的内容即可

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/ccc6d67fd7044c0e8e910bd3f3a41d40.png)

#### 系统页面中的logo、标题

找到资料中的logo文件，替换 src/assets/logo/logo.png文件

若依的系统页面标题引用的是开发环境的配置，我们只需要修改开发的环境的VITE\_APP\_TITLE属性即可

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/6610358a121f4a1c9364341e699b43d1.png)

#### 去除源码 & 文档

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/3ce6214d4f144187ad8036fffa0ab961.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/d84a9d416f5a4c4387ea087eba8b5099.png)

在前端代码中也有对应的操作，更好主题风格文件位置：src/setting.js

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/ecf256be193643d4bc687d9036bf0c0b.png)

更换主题颜色文件位置：src/store/modules/settings.js

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/064f30a3cfe74cc4a0c65b0520d5a013.png)

访问阿里巴巴矢量图库，搜索图标：https://www.iconfont.cn/search/index?searchType=icon&q=%E8%8F%9C%E5%93%81%E7%AE%A1%E7%90%86

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/99ee3a3eb3624ebcb65d4b8df7de3e57.png)

将下载好的图标复制到src/assets/icons/svg目录下，就可以给指定菜单设置图标了

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/4c521e0a24c14a17a6a140b3980e6802.png)  
 ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/357db4a492594b549d68e23e79a099ab.png)
...
[外链图片转存中...(img-ZLi2Toew-1736254025268)] 
...
[外链图片转存中...(img-VD5OHbSM-1736254025268)]   

[外链图片转存中...(img-mVjrMrOM-1736254025268)] 

### 浏览器标签页icon、标题

找到资料中的logo图标，替换前端项目中的public文件夹，删除原有的favicon.ico，把新拷贝过来的logo更名为favicon.ico即可

[外链图片转存中...(img-Pq2NtrzT-1736254025268)] 

找到根目录下的index.html文件，把title更换为自己想要的内容即可

[外链图片转存中...(img-S6CX69cT-1736254025268)] 

### 系统页面中的logo、标题

找到资料中的logo文件，替换 src/assets/logo/logo.png文件

[外链图片转存中...(img-Fcc3kGXi-1736254025268)] 

若依的系统页面标题引用的是开发环境的配置，我们只需要修改开发的环境的VITE_APP_TITLE属性即可

[外链图片转存中...(img-3HNtV2mc-1736254025268)] 

### 去除源码 & 文档

[外链图片转存中...(img-cWTTi4KI-1736254025269)] 
...
[外链图片转存中...(img-mWyLtBLC-1736254025269)] 

在前端代码中也有对应的操作，更好主题风格文件位置：src/setting.js

[外链图片转存中...(img-ej8XwduE-1736254025269)] 

更换主题颜色文件位置：src/store/modules/settings.js

[外链图片转存中...(img-Cytm9aXv-1736254025269)] 
...
[外链图片转存中...(img-VyRSXMMJ-1736254025269)] 

将下载好的图标复制到src/assets/icons/svg目录下，就可以给指定菜单设置图标了

[外链图片转存中...(img-RJjNFtsz-1736254025269)] 
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/6fd461ce6ab747a29a389ee9e6d31615.png)
