...
![image-20221112172846316](assets/image-20221112172846316.png)

**菜品分类管理效果：**

![image-20221112172925354](assets/image-20221112172925354.png)
...
![image-20221111161120975](assets/image-20221111161120975.png)
...
![image-20221111162912753](assets/image-20221111162912753.png) ![image-20221111162930483](assets/image-20221111162930483.png)
...
![外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传](https://img-home.csdnimg.cn/images/20230724024159.png?origin_url=assets%2Fimage-20221111180159188.png&pos_id=img-ImznoBTT-1734530708208)
...
![image-20221111164002448](assets/image-20221111164002448.png)

\*\*思考：\*\*是否可以使用对应的实体类来接收呢？

![image-20221111164453341](assets/image-20221111164453341.png)
...
在application.yml中已开启驼峰命名，故id\_number和idNumber可对应。
...
![image-20221111184934153](assets/image-20221111184934153.png)
...
![image-20221111185649636](assets/image-20221111185649636.png)
...
![image-20221111185901726](assets/image-20221111185901726.png)

**接口测试：**

![image-20221111190132481](assets/image-20221111190132481.png)

其中，请求头部含有JWT令牌

![image-20221111190248268](assets/image-20221111190248268.png)

**查看employee表：**

![外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传](https://img-home.csdnimg.cn/images/20230724024159.png?origin_url=assets%2Fimage-20221111191624908.png&pos_id=img-cQokypKc-1734530708208)
...
![image-20221111192339271](assets/image-20221111192339271.png)

保存后，查看employee表

![image-20221111192446950](assets/image-20221111192446950.png)
...
![image-20221111193700895](assets/image-20221111193700895.png)

后台报错信息：

![image-20221111194049620](assets/image-20221111194049620.png)

查看employee表结构：

![image-20221111194131787](assets/image-20221111194131787.png)
...
![image-20221111195521095](assets/image-20221111195521095.png)
